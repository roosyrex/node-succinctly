...
function Suite (options) {
  ...
  this.body        = typeof options.body === 'function' ? null : options.body;
  this.bodyFn      = typeof options.body === 'function' ? options.body : null;
  ...
  function tests () {
    ...
    _.each(self.tests, function (test) {
      ...
      it(testDescription, function (done) {
        ...
        if (self.bodyFn) self.body = self.bodyFn();
        if (self.body) requester.send(self.body);
